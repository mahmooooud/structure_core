...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.future_face.structure_core.StructureCorePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin structure_core, com.future_face.structure_core.StructureCorePlugin", e);
    }
    try {
