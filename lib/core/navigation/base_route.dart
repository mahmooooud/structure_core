...
class AppRouter extends $AppRouter {
  ...
  final List<AutoRoute> routes = [
    CupertinoRoute(page: SplashRoute.page, path: '/', children: [
      RedirectRoute(path: '*', redirectTo: ''),
    ]),
    CupertinoRoute(page: LoginRoute.page, path: '/', children: [
      RedirectRoute(path: '*', redirectTo: ''),
    ]),
    CupertinoRoute(page: SignUpScreenRoute.page, path: '/', children: [
      RedirectRoute(path: '*', redirectTo: ''),
    ]),
  ];
}
