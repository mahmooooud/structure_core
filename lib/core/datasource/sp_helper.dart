...
class SPHelper implements ISpHelper {
  ...
  double get fontSize {
    final prefs = GetIt.I<SharedPreferences>();
    var result = prefs.getDouble(ApplicationConstants.FONT_SIZE);
  ...
  Future<void> writeCheckedDate(DateTime dateTime)async{
    final prefs = GetIt.I<SharedPreferences>();
    await prefs.setString(ApplicationConstants.KEY_CHECKED_DATE, DateFormat('yyyy-MM-dd','en').format(dateTime));
  }
