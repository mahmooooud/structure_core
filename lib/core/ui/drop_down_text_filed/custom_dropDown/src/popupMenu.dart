...
/// {@end-tool}
///
/// See the tbc at [PopupMenuButton] for how this tbc could be used in a
/// complete menu, and see the tbc at [CheckedPopupMenuItem] for one way to
...
/// has the most room. For tbc, if the `position` describes a rectangle on
