...
// This widgets only exists to enable _PopupMenuRoute to save the sizes of
...
///
/// Typically the [child] of a [CustomPopupMenuItem] is a [Text] widgets. More
/// elaborate menus with icons can use a [ListTile]. By default, a
/// [CustomPopupMenuItem] is kMinInteractiveDimension pixels high. If you use a widgets
/// with a different height, it must be specified in the [height] property.
///
/// {@tool sample}
///
/// Here, a [Text] widgets is used with a popup menu item. The `WhyFarther` type
...
/// {@end-tool}
///
/// See the structure_core at [PopupMenuButton] for how this structure_core could be used in a
/// complete menu, and see the structure_core at [CheckedPopupMenuItem] for one way to
...
/// [CustomPopupMenuItem]. The first, `T`, must match the type argument of that widgets
...
/// has the most room. For structure_core, if the `position` describes a rectangle on
...
/// widgets can be safely removed from the tree before the popup menu is closed.
///
