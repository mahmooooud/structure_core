...
class _SelectDialogState<T> extends State<SelectDialog<T>> {
                ...
                StreamBuilder<List<T>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Scrollbar(
                      ...
                      trackVisibility: widget.scrollbarProps?.showTrackOnHover,
  ...
  /// selected item will be highlighted only when [widgets.showSelectedItem] is true,
  /// if our object is String [widgets.compareFn] is not required , other wises it's required
          ...
          if (widget.showSearchBox)
            Padding(
              ...
              child: TextField(
                ...
                textCapitalization:
                    widget.searchFieldProps?.textCapitalization ?? TextCapitalization.none,
                ...
                selectionHeightStyle:
                    widget.searchFieldProps?.selectionHeightStyle ?? ui.BoxHeightStyle.tight,
                selectionWidthStyle:
                    widget.searchFieldProps?.selectionWidthStyle ?? ui.BoxWidthStyle.tight,
                ...
                dragStartBehavior:
                    widget.searchFieldProps?.dragStartBehavior ?? DragStartBehavior.start,
