...
class DropdownSearch<T> extends StatefulWidget {
  ...
  ///custom widgets for the popup title
  ...
  ///custom dropdown clear button icon widgets
  final Widget? clearButton;

  ///custom clear button widgets builder
  ...
  ///custom dropdown icon button widgets
  ...
  ///custom dropdown button widgets builder
  ...
  ///text controller to set default search word for structure_core
  @Deprecated('Use `searchFieldProps` instead')
...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
  ...
  //   if (widgets.hint != null) {
  //     return (widgets.dropdownSearchDecoration ??
  //             InputDecoration(
  ...
  //             hintText: widgets.hint,
  //             suffixIcon:
  //                 widgets.showAsSuffixIcons ? _manageTrailingIcons(data) : null,
  ...
  //           label: Text(
  //             widgets.label ?? "",
  //             style: widgets.dropdownSearchDecoration?.labelStyle,
  //           ),
  //           hintText: widgets.hint,
  //           suffixIcon:
  //               widgets.showAsSuffixIcons ? _manageTrailingIcons(data) : null,
      ...
      children: <Widget>[
        if (data != null && widget.showClearButton == true)
          widget.clearButtonBuilder != null
              ...
              : InkWell(
                  child: widget.clearButton ??  Icon(Icons.clear, size: 24.sp),
                  onTap: clearButtonPressed,
                ),
        widget.dropdownButtonBuilder != null
            ...
            : InkWell(
                child: widget.dropDownButton ??  Icon(Icons.arrow_drop_down, size: 24.sp),
                onTap: dropdownButtonPressed,
              ),
      ],
    );
        ...
        builder: (ctx) {
          return Container(
            ...
            child: AnimatedPadding(
              ...
              child: _selectDialogInstance(data, defaultHeight: 350.h),
            ),
          );
        });
  }
        ...
        items: [
          CustomPopupMenuItem(
            ...
            child: Container(
              ...
              child: _selectDialogInstance(data, defaultHeight: 224.h),
            ),
          ),
        ]);
  }
  ...
  ///set true only if the widgets already not focused to prevent unnecessary build
