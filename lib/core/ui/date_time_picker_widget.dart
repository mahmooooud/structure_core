  ...
  void dateTimePickerWidget(BuildContext context, String dateFormat, DateTimePickerLocale locale,
    ...
    DatePicker.showDatePicker(
      ...
      pickerTheme: DateTimePickerTheme(
        showTitle: true,
        confirm: Text(confirmText, style: context.textTheme.button!.copyWith(color: Colors.white)),
        cancel: Text(cancelText, style: context.textTheme.button!.copyWith(color: Colors.white)),
        backgroundColor: Colors.white,
        itemHeight: 60.h,
        titleHeight: 60.h,
        pickerHeight: (MediaQuery.of(context).size.height * 0.5).h,
      ),
      onConfirm: onConfirm,
    );
  }
